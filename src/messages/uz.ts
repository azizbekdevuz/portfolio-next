...
export const messages = {
  ...
  downloads: {
    resumeTitle: "Rezyume",
    resumeSummary: "Rolga mos linzani tanlang.",
    portfolioTitle: "Portfolio PDF",
    portfolioSummary: "Yo‘nalish bo‘yicha case PDF lar.",
    pdfPending: "PDF ulangan emas — src/content/downloads.ts da yo‘l qo‘ying",
    lens: {
  ...
  languageMatrix: {
    ...
    languages: {
      en: {
        name: "Ingliz tili",
        levelLabel: "Erkin",
        domains: ["Texnik", "Biznes", "Akademik", "Kundalik"] as const,
        keywords: ["IELTS 6.5", "Texnik yozuv", "Nutq"] as const,
      },
      ko: {
        name: "Koreys tili",
        levelLabel: "O‘rta",
        domains: ["Akademik", "Kundalik", "Boshlang‘ich biznes"] as const,
        keywords: ["TOPIK", "Universitet darajasi", "Suhbat"] as const,
      },
      uz: {
        name: "O‘zbek tili",
        levelLabel: "Ona tili",
        domains: ["Ona tili", "Adabiy", "Texnik", "Akademik"] as const,
        keywords: ["Ona tili", "Texnik tarjima", "Kontent"] as const,
      },
      ru: {
        name: "Rus tili",
        levelLabel: "Suhbat darajasi",
        domains: ["Biznes", "Texnik", "Akademik", "Adabiyot"] as const,
        keywords: ["Biznes muloqoti", "Texnik hujjatlar", "Adabiyot"] as const,
      },
    },
  },
  experience: {
